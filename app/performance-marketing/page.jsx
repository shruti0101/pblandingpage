...
const testimonials = [
  ...
  return (
    ...
    <div>
        <section className='bg-cover bg-center bg-no-repeat w-full h-[60vh] py-2' style={{backgroundImage:"url(https://res.cloudinary.com/dzbkxqqo9/image/upload/v1764226684/10_aigaty.webp)"}}>
...
{/* industy */}
   <section className="w-full flex flex-col gap-7 bg-black pb-3">

      {/* Heading */}
      <div className="text-center py-4">
        <h2 className="text-[#155DFC] text-2xl font-semibold tracking-wide">
          Industry Specific
        </h2>
        <h3 className="text-[#155DFC] text-2xl font-semibold">
          Expertise
        </h3>
      </div>
  ...
  <div className="space-y-5 px-4 relative">
    ...
    {[
      ...
      },
      {
        ...
        desc: "High-converting websites built for speed, growth & performance.",
