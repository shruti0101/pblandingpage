...
//     try {
//       const res = await fetch("https://formsubmit.co/ajax/info@promozionebranding.com", {
//         method: "POST",
//         headers: {
...
//             </h6>
//             <Image width={100}
//             height={200}src="https://res.cloudinary.com/dzbkxqqo9/image/upload/v1762323988/gmb_xyshno.webp" alt="google review" className="w-56 h-auto mx-auto mb-3 rounded" />
...
//             <input type="text" name="name" placeholder="Name" required className="w-full p-2 text-white rounded-md border border-white focus:ring-2 focus:ring-blue-500 outline-none" />
//             <input type="email" name="email" placeholder="Email ID" required className="w-full p-2 rounded-md text-white border border-white focus:ring-2 focus:ring-blue-500 outline-none" />
//             <input type="tel" name="phone" maxLength={10} pattern="[0-9]{10}" placeholder="Mobile No." className="w-full p-2 rounded-md text-white border border-white focus:ring-2 focus:ring-blue-500 outline-none" />
//             <textarea rows="3" name="message" placeholder="Explain your requirements (minimum 50 characters)" required className="w-full p-2 rounded-md border border-white text-white focus:ring-2 focus:ring-blue-500 outline-none"></textarea>

//             <button type="submit" className="w-full bg-green-600 hover:bg-green-500 text-white font-semibold py-2 rounded-full transition">
//               Submit Now
//             </button>
//           </form>
//         </div>
